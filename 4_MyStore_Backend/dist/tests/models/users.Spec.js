...
describe('User Model', () => {
    ...
    it('create method should add a user', async () => {
        ...
        expect(bcryptjs_1.default.compareSync(user.password_digest + pepper, createResult.password_digest)).toBeTruthy;
    });
    ...
    it('show method should return the correct user', async () => {
        ...
        expect(bcryptjs_1.default.compareSync(user.password_digest + pepper, showResult.password_digest)).toBeTruthy;
    });
    it('authenticate method should return an authenticated user', async () => {
        ...
        expect(bcryptjs_1.default.compareSync(user.password_digest + pepper, authenticateResult.password_digest)).toBeTruthy;
    });
